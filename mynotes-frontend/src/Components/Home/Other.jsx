...
const Other = () => {
    return (
        <div className="flex flex-col-reverse md:flex-row items-center gap-0 md:gap-10 mx-4 md:mx-10">
            ...
            <div className="w-full md:w-2/3  md:px-20 md:py-20 mt-10 md:mt-0">
                <h1 className="md:ml-8 mb-6 text-4xl md:text-5xl font-bold text-center md:text-start text-cyan-500 md:my-2">Welcome to <span className="text-purple-500">NotHi</span></h1>
